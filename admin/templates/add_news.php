...
if(isset($_SESSION['add_news']['res'])){
    ...
    unset($_SESSION['add_news']['res']); // разрегистрировали переменную $_SESSION['add_news']['res']
} 
?>
    <form action="" method="post">
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            <tr>
                <td class="add-edit-txt">Заголовок новости:</td>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor1" class="full-text" name="anons" title="fd"><?=$_SESSION['add_news']['anons']?></textarea>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor2" class="full-text" name="text" title="fd"><?=$_SESSION['add_news']['text']?></textarea>
                    <script type="text/javascript">
