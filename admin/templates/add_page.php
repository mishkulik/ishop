...
if(isset($_SESSION['add_page']['res'])){
    ...
    unset($_SESSION['add_page']['res']); // разрегистрировали переменную $_SESSION['add_page']['res']
} 
?>
    <form action="" method="post">
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor1" class="full-text" name="text" title="fd"><?=$_SESSION['add_page']['text']?></textarea>
