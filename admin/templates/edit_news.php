...
if(isset($_SESSION['edit_news']['res'])){
    ...
    unset($_SESSION['edit_news']['res']); // разрегистрировали переменную $_SESSION['edit_news']['res']
} 
?>
    <form action="" method="post">
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor1" class="full-text" name="anons" title="fd"><?=$get_news['anons']?></textarea>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor2" class="full-text" name="text" title="fd"><?=$get_news['text']?></textarea>
                    <script type="text/javascript">
