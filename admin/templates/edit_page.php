...
if(isset($_SESSION['edit_page']['res'])){
    ...
    unset($_SESSION['edit_page']['res']); // разрегистрировали переменную $_SESSION['edit_page']['res']
} 
?>
    <form action="" method="post">
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>Описание:</td>
                <td><input class="head-text" type="text" name="descriptions" value="<?=htmlspecialchars($get_page['description'])?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor1" class="full-text" name="text" title="fd"><?=$get_page['text']?></textarea>
