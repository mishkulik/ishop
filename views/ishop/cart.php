...
//print_arr($_SESSION['cart']);
 ...
 <?php endforeach; ?>
        <tr>
            ...
            <td class="z_bot" colspan="3" align="right"><?=$_SESSION['total_quantity']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span><?=$_SESSION['total_sum']?></span> руб.</td>                
        </tr>
    ...
    <div class="sposob-dostavki">
        ...
        <p><label><input type="radio" name="dostavka" value="<?=$item['dostavka_id']?>" /> <?=$item['name']?></label></p>
        <?php endforeach; ?>
    </div>
 ...
 <?php if(!$_SESSION['auth']['user']): // проверка авторизации ?>
    <table class="zakaz-data" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr class="notauth">
            ...
            <td class="zakaz-prim">Пример: 8 997 999 99 99</td>
        </tr>   
        <tr class="notauth">
        ...
        <tr>
            ...
            <td class="zakaz-prim" style="vertical-align:top">Пример: Позвоните, пожалуйста, после 10 вечера, до этого времени я на работе.</td>
        </tr>
    </table>
